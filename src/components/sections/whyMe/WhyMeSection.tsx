  ...
  return (
    <section className="my-8">
      ...
      <div className="flex flex-col items-center gap-2 lg:flex-row lg:flex-wrap lg:justify-center">
        <div className="card md:mr-auto lg:mr-0">
          <RiTeamFill className="icon flex-shrink-0" />
          <div>
        ...
        <div className="card">
          <GiCrystalGrowth className="icon flex-shrink-0 " />
          <div>
        ...
        <div className="card md:ml-auto lg:ml-0">
          <FaCircleNodes className="icon flex-shrink-0" />
          <div>
